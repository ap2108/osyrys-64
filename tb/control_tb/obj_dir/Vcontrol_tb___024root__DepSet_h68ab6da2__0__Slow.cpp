...
#endif
            VL_FATAL_MT("control_tb.sv", 3, "", "Settle region did not converge.");
        }
...
void Vcontrol_tb___024root___act_sequent__TOP__0(Vcontrol_tb___024root* vlSelf);
...
VL_ATTR_COLD void Vcontrol_tb___024root___ctor_var_reset(Vcontrol_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->control_tb__DOT__opcode = VL_RAND_RESET_I(7);
    vlSelf->control_tb__DOT__funct3 = VL_RAND_RESET_I(3);
    vlSelf->control_tb__DOT__funct7 = VL_RAND_RESET_I(7);
    vlSelf->control_tb__DOT__reg_write_en = VL_RAND_RESET_I(1);
    vlSelf->control_tb__DOT__alu_src = VL_RAND_RESET_I(1);
    vlSelf->control_tb__DOT__mem_read = VL_RAND_RESET_I(1);
    vlSelf->control_tb__DOT__mem_write = VL_RAND_RESET_I(1);
    vlSelf->control_tb__DOT__mem_to_reg = VL_RAND_RESET_I(1);
    vlSelf->control_tb__DOT__branch = VL_RAND_RESET_I(1);
    vlSelf->control_tb__DOT__is_npu_matrix_mul = VL_RAND_RESET_I(1);
    vlSelf->control_tb__DOT__is_npu_conv = VL_RAND_RESET_I(1);
    vlSelf->control_tb__DOT__dut__DOT__alu_control_enum = VL_RAND_RESET_I(4);
